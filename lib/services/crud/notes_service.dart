...
class DatabaseNote {
  ...
  DatabaseNote.fromRow(Map<String, Object?> map)
      : id = map[idColumn] as int,
        ...
        isSyncedWithCloud =
            (map[isSyncedWithCloudCollumn] as int) == 1 ? true : false;
...
const isSyncedWithCloudCollumn = 'is_synced_with_cloud';
